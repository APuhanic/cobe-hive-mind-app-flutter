...
abstract class _$$_LoadingCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T? dataMaybe});
}

/// @nodoc
class __$$_LoadingCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$_Loading<T>>
  ...
  @override
  $Res call({
    Object? dataMaybe = freezed,
  }) {
    return _then(_$_Loading<T>(
      freezed == dataMaybe
          ? _value.dataMaybe
          : dataMaybe // ignore: cast_nullable_to_non_nullable
              as T?,
    ));
  }
}
...
class _$_Loading<T> implements _Loading<T> {
  const _$_Loading(this.dataMaybe);
  ...
  @override
  String toString() {
    return 'ApiState<$T>.loading(dataMaybe: $dataMaybe)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.dataMaybe, dataMaybe));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(dataMaybe));
...
abstract class _Loading<T> implements ApiState<T> {
  const factory _Loading(final T? dataMaybe) = _$_Loading<T>;
...
class __$$_SuccessCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$_Success<T>>
...
class __$$_ErrorCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$_Error<T>>
